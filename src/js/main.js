...
(function ($) {
	...
	$("pre code").each(function () {
		// enable contenteditable for code manipulation prior to copying
		// contenteditable for easier copy paste (cmd+a to select all)
		// disable spellcheck to avoid red underlines when browser doesn't recognize coding terms
	...
	const searchList = new List("searchlist", searchOptions);
})(jQuery);
